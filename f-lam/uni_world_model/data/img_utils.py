...
from torchvision.transforms.v2 import Resize, RandomResizedCrop, ColorJitter, InterpolationMode, Lambda
...
class RGB_PreProcessor(torch.nn.Module): 
    def __init__(
        ...
        train_transforms.append(Lambda(lambda x: torch.clamp(x, 0.0, 1.0)))
